...
angular.module('bahmni.common.domain')
    .factory('programService', ['$http', 'programHelper', 'appService', function ($http, programHelper, appService) {
        ...
        var getProgramAttributeTypes = function () {
            return $http.get(Bahmni.Common.Constants.programAttributeTypes, {params: {v: 'custom:(uuid,name,description,datatypeClassname,datatypeConfig,concept)', limit : 300}}).then(function (response) {
